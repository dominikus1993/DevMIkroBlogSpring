...
appModule.controller("PostController", ["$rootScope", "$scope", "PostService", "UserService", ($rootScope, $scope, postService, userService) => new Controllers.PostController($rootScope, $scope, postService, userService)]);
